...
public class DirectorMovimiento {
     ...
     */
    public Movimiento crearDeposito(CuentaBancaria cuentaDestino, double monto, @Nullable String descripcion) {
        ...
        Movimiento.Builder builder = new Movimiento.Builder()
                ...
                .setId(SistemaBilleteraFacade.getInstancia().generarCodigoId())
